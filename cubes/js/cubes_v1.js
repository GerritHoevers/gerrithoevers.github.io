...
/******/ (() => {
  ...
  \*******************************************************/
      /***/ (
        ...
        const cube1 = new three__WEBPACK_IMPORTED_MODULE_3__.Mesh(
          cube1Geometry,
          cube1Material
        );
        ...
        const cube2 = new three__WEBPACK_IMPORTED_MODULE_3__.Mesh(
          cube2Geometry,
          cube2Material
        );
        ...
        //   new three__WEBPACK_IMPORTED_MODULE_3__.TorusKnotBufferGeometry(
        //     0.5,
        //     0.2,
        //     300,
        //     300
        ...
        //     roughness: 0.1,
        //   });
        // const torusKnotMesh = new three__WEBPACK_IMPORTED_MODULE_3__.Mesh(
        //   torusKnotGeometry,
        //   torusKnotMat
        // );
        ...
        const groundGeometry =
          new three__WEBPACK_IMPORTED_MODULE_3__.PlaneBufferGeometry(
            10000,
            10000
          );
        ...
        gui.add(props, "cube1Speed", -0.2, 0.2, 0.01);
        gui.add(props, "cube2Speed", -0.2, 0.2, 0.01);
        ...
        function animate() {
          ...
          renderer.render(scene, camera);
          stats.update();
          cube1.rotation.x += props.cube1Speed;
          cube1.rotation.y += props.cube1Speed;
          cube1.rotation.z += props.cube1Speed;

          cube2.rotation.x += props.cube2Speed;
          cube2.rotation.y += props.cube2Speed;
          cube2.rotation.z += props.cube2Speed;
